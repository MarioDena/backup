  ...
  <div>
    ...
    <div class="mainContent">
      <Container>
        ...
        <Row>
          <Col>
            <h4 in:fade class="font title">Find what you need</h4>
            <p in:fade class="font subTitle">Pre-book products and services at the best cost</p>
          </Col>
          <Col cols="5">
        ...
        <Row style="justify-content: center"
          ><img style="margin-top: 20px; margin-bottom: 60px" src={generalAssets.searchDummy} alt="" /></Row
        >
        <Row style="justify-content: center">
          <img style="margin-left: 20px" src={generalAssets.footertravels} alt="" />
        </Row>
      </Container>
    </div>
