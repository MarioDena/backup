<script>
	...
	import { Avatar, ProgressLinear, Row, Col, Select } from "svelte-materialify";
				...
				<Row>
					<Col>
						...
						<p in:fade class="font subTitle">
							{$t("general.greeting2")}
							{` ${localUserShoten} `}
							{$t("general.greetingDashboard")}.
						</p>
					</Col>
				</Row>
				<Row>
					<Col cols="7">
						<p in:fade class="fontBold subTitle">{$t("general.newsTitle")}</p>
						<div in:fade class="newsContainer">
							<p class="newsTitle">{$t("general.newsCongressTitle")}</p>
							<p class="font newsSubtitle">
								{$t("general.newsCongressDate")}
							</p>
						</div>
						<div in:fade class="newsContainer">
							<p class="newsTitle">{$t("general.newsSenateTitle")}</p>
							<p class="font newsSubtitle">
								{$t("general.newsSenateDate")}
							</p>
						</div>
						<div in:fade class="newsContainer">
							<p class="newsTitle">{$t("general.newsLegislationTitle")}</p>
							<p class="font newsSubtitle">
								{$t("general.newsLegislationDate")}
							</p>
						</div>
						<div in:fade class="newsContainer">
							<p class="newsTitle">{$t("general.newsPartnerTitle")}</p>
							<p class="font newsSubtitle">
								{$t("general.newsPartnerDate")}
							</p>
						</div>
					</Col>
					<Col cols="5">
						...
						<div in:fade class="statsContainer2">
							<img
								style="margin-left: -25px; margin-top: 20px; margin-bottom: 20px"
								src={generalAssets.applicationStatus}
								alt=""
							/>
						</div>
					</Col>
